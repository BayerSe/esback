#' Returns and risk forecasts for the S&P 500
#'
#' A dataset containing the returns and risk forecasts
#' for the S&P 500 daily log returns. All risk forecasts are for the
#' probability 2.5\%.
#'
#' \itemize{
